 ...
 * @since solr 1.3
 */ 
public class OverridedSolrResourceLoader implements ResourceLoader
{
  public static final Logger log = LoggerFactory.getLogger(OverridedSolrResourceLoader.class);
   ...
   * @see #locateSolrHome
   */
  public OverridedSolrResourceLoader( String instanceDir, ClassLoader parent, Properties coreProperties )
  {
    if( instanceDir == null ) {
      this.instanceDir = OverridedSolrResourceLoader.locateSolrHome();
    ...
    this.classLoader = parent; //createClassLoader(null, parent);
   ...
   * <p>
   */
  public OverridedSolrResourceLoader( String instanceDir, ClassLoader parent )
  {
...
/*  private static URLClassLoader replaceClassLoader(final URLClassLoader oldLoader,
  ...
  public OverridedSolrResourceLoader( String instanceDir )
  {
  ...
  public <T> Class<? extends T> findClass(String cname, Class<T> expectedType, String... subpackages) {
    ...
    try {
      ...
      // using a shortname
      if ( clazz != null &&
              clazz.getClassLoader() == OverridedSolrResourceLoader.class.getClassLoader() &&
